...
<h2>This is the whole data base inventory <br> please write the product id number to be deleted</h2>
<br>
    <table>
    <tr>
        <th>Id</th>
...
<form action="delete2.php" method="GET" > Enter a Food id to be deleted: <input name="id" type="text" required> <br><br> <input type="submit"> </form>
